...
// import { BaseUrl, BlogItems } from '../components/data/data'
...
//     console.log('Fetched blog data:', BlogItemsData, 'items')
...
async function Page() {
  let data =[]
    try {
      const res = await fetch('http://127.0.0.1:8000/api/product/ctd-sensor');
      ...
      const jsonData = await res.json(); // Call res.json() only once
